...
![Version: 1.0.0-rc.2](https://img.shields.io/badge/Version-1.0.0--rc.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.0.0-rc.1](https://img.shields.io/badge/AppVersion-v1.0.0--rc.1-informational?style=flat-square)
...
for requirements and credentials, the [Helm installation guide](https://github.com/vatesfr/xenorchestra-csi-driver/blob/main/docs/install-helm.md)
for the Helm test, and the [Usage and Examples guide](https://github.com/vatesfr/xenorchestra-csi-driver/blob/main/docs/usage.md)
for StorageClass examples and the full parameter reference.
