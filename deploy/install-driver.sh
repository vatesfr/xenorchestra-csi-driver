...
# using example: ./install-driver.sh [local|master|any remote branch] [snapshot]
...
echo "Installing Xen Orchestra CSI driver, version: $ver ..."
...
echo 'Xen Orchestra CSI driver installed successfully.'